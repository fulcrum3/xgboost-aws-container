...
# This is a custom python 3 image that uses the nginx, gunicorn, flask stack
...
RUN wget https://bootstrap.pypa.io/3.3/get-pip.py && python3.6 get-pip.py && \
    pip3 install numpy==1.17.4 scipy scikit-learn==0.22.1 xgboost==0.90 pandas==0.25.3 flask gevent gunicorn && \
